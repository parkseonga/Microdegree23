...
if task == "classification":
    loaded_dataset = np.load('/Users/jinerd/Documents/ml/capstone/data/all_clf_arr.npz', allow_pickle = True)
else:
    loaded_dataset = np.load('/Users/jinerd/Documents/ml/capstone/data/all_reg_arr.npz', allow_pickle = True)
print("complete load")
...
if task == "classification":
    caseids_train, caseids_valid, caseids_test = pickle.load(open('/Users/jinerd/Documents/ml/capstone/data/clf_train_valid_test_caseids.pkl', 'rb'))
else:
    caseids_train, caseids_valid, caseids_test = pickle.load(open('/Users/jinerd/Documents/ml/capstone/data/regtrain_valid_test_caseids.pkl', 'rb'))
